...
Before accessing the services please set your password at https://support.forgeservicelab.fi/password/?action=sendtoken

In case you have requested computing capacity then please note that it takes about 10 minutes until OpenStack cloud services become accessible.
All other services are accessible immediately after you have set your password.

You can next proceed to https://forgeservicelab.fi and click login. After that you should see black editing bar with the text "Add Content". There you can fill in your organization description and offering descriptions.
Please email or call Katariina Kalatie if you encounter any problems. Email: katariina.kalatie@digile.fi, tel. +358 50 4836372.
...
We just wanted to inform you that we have now completed the FORGE Service Lab account creation for your Technical contact.
...
def sendCannedMail(to, cannedMessage, token):
